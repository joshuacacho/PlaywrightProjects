...
//using global value for retrying on a global level where all tests within the project will consume within the package.config.js file
test("HTTPS Status Error - Using package.config.js Global Setting permissions with geolocation", async({page}) => {
