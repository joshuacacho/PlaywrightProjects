...
/*
    This test case is a cotinuatuon from Step 1 where we will now
...
test.beforeAll("Step 1 - Group Booking - Successful Log In Using Reusable loginAndInitPageObjects(page) helper", async ({ browser }) => {
    try {
...
test("Step 6 - Group Booking - POST Login - Validate result", async () => {
    ...
    try {
        ...
        await expect(refundStatusText).toContain("Not eligible for refund. Group bookings (3 tickets) are non-refundable.")
